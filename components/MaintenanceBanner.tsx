...
import { MaintenanceInterface } from "@/lib/interface";
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          const newValue = payload.new.value as MaintenanceInterface;
  ...
  return (
    <div className="fixed w-full bottom-0 bg-yellow-400 text-yellow-900 px-4 py-3 shadow-md z-50">
      <div className="mx-auto flex items-center justify-between">
        <AlertTriangle className="hidden md:inline h-5 w-5 shrink-0" />
